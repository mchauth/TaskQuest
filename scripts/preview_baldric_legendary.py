#!/usr/bin/env python3
"""Preview the baldric-chest legendaries for daily approval. For each class and
gender: full avatar (skin+chest+hair) across idle/walk/run/cheer/slash, plus one
isolated chest-over-skin (no hair) so the net-new diagonal-baldric geometry is
clear. Writes to $OUTP (default PREVIEW_baldric_legendary.png)."""
import os
from PIL import Image, ImageDraw, ImageFont

CH = "sprites/preview_assets/char"
PREV = "_baldric_legendary_preview"
FW, FH, COLS = 80, 64, 10
OUT = os.environ.get("OUTP", "PREVIEW_baldric_legendary.png")
FRAMES = [(0, "idle"), (12, "walk"), (22, "run"), (41, "cheer"), (52, "slash")]
CLASSES = [
    ("warrior", "shirt_warrior_legendary6", "Sovereign's Baldric"),
    ("mage", "shirt_mage_legendary6", "Astral Baldric"),
    ("ranger", "shirt_ranger_legendary6", "Warden's Baldric"),
]
...
def main():
    ...
    for cls, stem, disp in CLASSES:
        d.text((pad, y), f"{disp}  ({cls}, HYPER-RARE chest — net-new DIAGONAL baldric geometry)",
