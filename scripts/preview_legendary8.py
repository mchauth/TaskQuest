#!/usr/bin/env python3
"""Approval preview for the 8th legendary sets (2026-07-25 batch):
  Molten Sovereign (warrior), Sapphire Magus (mage), Rosewild Warden (ranger).
...
right = the NEW legendary. Writes _PREVIEW_legendary8.png and a copy to the
...
OUTDIR = "/sessions/cool-inspiring-galileo/mnt/outputs"

# (title, source-tier token, preview-dir, legendary-suffix, swatch)
SETS = [
    ("Molten Sovereign (Warrior)", "rare1", "_warrior_legendary8_preview", "_rare8", (228, 134, 36)),
    ("Sapphire Magus (Mage)", "mage4", "_mage_legendary8_preview", "_rare_mage8", (48, 100, 210)),
    ("Rosewild Warden (Ranger)", "ranger4", "_ranger_legendary8_preview", "_rare_ranger8", (232, 100, 160)),
]
...
def main():
    ...
    d.text((pad, 12), "TaskQuest — 8th Legendary Sets  (2026-07-25, awaiting approval)", font=fH, fill=(240, 240, 250))
    ...
    img.convert("RGB").save("_PREVIEW_legendary8.png")
    os.makedirs(OUTDIR, exist_ok=True)
    img.convert("RGB").save(os.path.join(OUTDIR, "PREVIEW_legendary8.png"))
    print("wrote _PREVIEW_legendary8.png and outputs/PREVIEW_legendary8.png", img.size)
