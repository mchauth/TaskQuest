#!/usr/bin/env python3
"""Preview the flared hip-wing cuisse legs for daily approval. For each class and
gender: full avatar (skin+legs+hair) across idle/walk/run/cheer/slash, plus one
isolated legs-over-skin so the net-new hip-wing geometry is clear.
Writes to $OUTP (default PREVIEW_cuisse_legs.png)."""
import os
from PIL import Image, ImageDraw, ImageFont

CH = "sprites/preview_assets/char"
PREV = "_cuisse_legs_preview"
FW, FH, COLS = 80, 64, 10
OUT = os.environ.get("OUTP", "PREVIEW_cuisse_legs.png")
FRAMES = [(0, "idle"), (12, "walk"), (22, "run"), (41, "cheer"), (52, "slash")]
CLASSES = [
    ("warrior", "pants_warrior_legendary5", "Warlord's Bulwark Cuisses"),
    ("mage", "pants_mage_legendary5", "Astral Warding Cuisses"),
    ("ranger", "pants_ranger_legendary5", "Wildwood Warden Cuisses"),
]
...
def main():
    ...
    for cls, stem, disp in CLASSES:
        d.text((pad, y), f"{disp}  ({cls}, HYPER-RARE legs — net-new flared hip-wing cuisse geometry)",
