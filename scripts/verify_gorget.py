#!/usr/bin/env python3
"""Rigorous per-sheet verification for the gorget legendaries (see verify_tabard.py).
For each of the 6 sheets, vs its source t4-chest sheet:
  ...
  3. accent-caused multi-component frames = frames whose OUTPUT has >1 connected
     component beyond what the SOURCE already has (should be 0 -> every collar fused)
...
PAIRS = [
    ("armor_chest_4", "shirt_warrior_legendary5"),
    ("shirt_mage4", "shirt_mage_legendary5"),
    ("shirt_ranger4", "shirt_ranger_legendary5"),
]
