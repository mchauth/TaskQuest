#!/usr/bin/env python3
"""Rigorous per-sheet verification for the greave boots legendaries.
For each of the 6 sheets, vs its source t4-boots sheet:
  ...
  3. accent-caused multi-component frames = frames whose OUTPUT has >1 connected
     component beyond what the SOURCE already has (0 -> every greave fused)
...
PAIRS = [
    ("armor_boots_4", "boots_warrior_legendary_greave"),
    ("boots_mage4", "boots_mage_legendary_greave"),
    ("boots_ranger4", "boots_ranger_legendary_greave"),
]
