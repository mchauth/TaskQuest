#!/usr/bin/env python3
"""Preview the knee-cop poleyn legs for daily approval. For each class and
gender: full avatar (skin+legs+chest+hair) across idle/walk/run/cheer/slash,
plus one isolated legs-over-skin so the net-new knee-cop geometry is clear.
Writes to $OUTP (default PREVIEW_poleyn_legs.png)."""
import os
from PIL import Image, ImageDraw, ImageFont

CH = "sprites/preview_assets/char"
PREV = "_poleyn_legs_preview"
FW, FH, COLS = 80, 64, 10
OUT = os.environ.get("OUTP", "PREVIEW_poleyn_legs.png")
FRAMES = [(0, "idle"), (12, "walk"), (22, "run"), (41, "cheer"), (52, "slash")]
CLASSES = [
    ("warrior", "pants_warrior_legendary4", "Warlord's Aegis Poleyns"),
    ("mage", "pants_mage_legendary4", "Astral Rose-Poleyns"),
    ("ranger", "pants_ranger_legendary4", "Wildwood Bone-Poleyns"),
]
...
def main():
    ...
    for cls, stem, disp in CLASSES:
        d.text((pad, y), f"{disp}  ({cls}, HYPER-RARE legs — net-new knee-cop poleyn geometry)",
