#!/usr/bin/env python3
"""Preview the downward beast-claw talon boots for daily approval. For each class
...
downward beast-claw talon geometry is clear. Writes to $OUTP (default
_PREVIEW_claw_boots.png)."""
import os
from PIL import Image, ImageDraw, ImageFont

CH = "sprites/preview_assets/char"
PREV = "_claw_boots_preview"
FW, FH, COLS = 80, 64, 10
OUT = os.environ.get("OUTP", "_PREVIEW_claw_boots.png")
FRAMES = [(0, "idle"), (12, "walk"), (22, "run"), (41, "cheer"), (52, "slash")]
CLASSES = [
    ("warrior", "boots_warrior_legendary_claw", "Ironrend Talons"),
    ("mage", "boots_mage_legendary_claw", "Voidrend Talons"),
    ("ranger", "boots_ranger_legendary_claw", "Wildclaw Talons"),
]
...
def main():
    ...
    for cls, stem, disp in CLASSES:
        d.text((pad, y), f"{disp}  ({cls}, HYPER-RARE boots — net-new DOWNWARD beast-claw talon geometry, 6th boots axis)",
