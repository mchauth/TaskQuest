#!/usr/bin/env python3
"""Preview the tabard-chest legendaries for daily approval. For each class and
gender: full avatar (skin+chest+hair) across idle/walk/run/cheer/slash, plus one
isolated chest-over-skin so the net-new centered-tabard geometry is clear.
Writes to $OUTP (default PREVIEW_tabard_legendary.png)."""
import os
from PIL import Image, ImageDraw, ImageFont

CH = "sprites/preview_assets/char"
PREV = "_tabard_legendary_preview"
FW, FH, COLS = 80, 64, 10
OUT = os.environ.get("OUTP", "PREVIEW_tabard_legendary.png")
FRAMES = [(0, "idle"), (12, "walk"), (22, "run"), (41, "cheer"), (52, "slash")]
CLASSES = [
    ("warrior", "shirt_warrior_legendary4", "Sovereign's Tabard"),
    ("mage", "shirt_mage_legendary4", "Runeweave Tabard"),
    ("ranger", "shirt_ranger_legendary4", "Warden's Tabard"),
]
...
def main():
    ...
    for cls, stem, disp in CLASSES:
        d.text((pad, y), f"{disp}  ({cls}, HYPER-RARE chest — net-new centered-tabard geometry)",
