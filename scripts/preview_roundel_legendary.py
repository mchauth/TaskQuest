#!/usr/bin/env python3
"""Preview the Aegis-roundel chest legendaries (8th chest axis) for daily
...
net-new central circular boss geometry is clear. Writes to $OUTP (default
_PREVIEW_roundel_legendary.png)."""
import os
from PIL import Image, ImageDraw, ImageFont

CH = "sprites/preview_assets/char"
PREV = "_roundel_legendary_preview"
FW, FH, COLS = 80, 64, 10
OUT = os.environ.get("OUTP", "_PREVIEW_roundel_legendary.png")
FRAMES = [(0, "idle"), (12, "walk"), (22, "run"), (41, "cheer"), (52, "slash")]
CLASSES = [
    ("warrior", "shirt_warrior_legendary8", "Sovereign's Aegis"),
    ("mage", "shirt_mage_legendary8", "Astral Aegis"),
    ("ranger", "shirt_ranger_legendary8", "Warden's Aegis"),
]
...
def main():
    ...
    for cls, stem, disp in CLASSES:
        d.text((pad, y), f"{disp}  ({cls}, HYPER-RARE chest — net-new CIRCULAR BOSS/ROUNDEL, 8th chest axis (repaint, QA-safe))",
