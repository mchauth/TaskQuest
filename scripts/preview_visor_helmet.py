#!/usr/bin/env python3
"""Preview the visored faceplate helmets for daily approval. For each class and
gender: full avatar (skin + base pants + base shirt + hair + visor helmet) across
idle/walk/run/cheer/slash, plus one isolated helmet-over-skin so the net-new
face-covering faceplate geometry is clear. Writes to $OUTP (default
_PREVIEW_visor_helmet.png)."""
import os
from PIL import Image, ImageDraw, ImageFont

CH = "sprites/preview_assets/char"
PREV = "_visor_helmet_preview"
FW, FH, COLS = 80, 64, 10
OUT = os.environ.get("OUTP", "_PREVIEW_visor_helmet.png")
FRAMES = [(0, "idle"), (12, "walk"), (22, "run"), (41, "cheer"), (52, "slash")]
CLASSES = [
    ("warrior", "helmet_warrior_legendary5", "Ironclad Visor"),
    ("mage", "helmet_mage_legendary5", "Voidgaze Visor"),
    ("ranger", "helmet_ranger_legendary5", "Wildmaw Visor"),
]
...
def main():
    ...
    for cls, stem, disp in CLASSES:
        d.text((pad, y), f"{disp}  ({cls}, HYPER-RARE helmet — net-new face-covering visored-faceplate geometry)",
