#!/usr/bin/env python3
"""Rigorous per-sheet verification for the faulds legs legendaries.
For each of the 6 sheets, vs its source t4-pants sheet:
  ...
  3. accent-caused multi-component frames = frames whose OUTPUT has >1 connected
     component beyond what the SOURCE already has (0 -> every fauld fused)
...
PAIRS = [
    ("armor_pants_4", "pants_warrior_legendary3"),
    ("pants_mage4", "pants_mage_legendary3"),
    ("pants_ranger4", "pants_ranger_legendary3"),
]
