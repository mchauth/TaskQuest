...
_PREVIEW_strap_boots.png)."""
import os
from PIL import Image, ImageDraw, ImageFont

CH = "sprites/preview_assets/char"
PREV = "_strap_boots_preview"
FW, FH, COLS = 80, 64, 10
OUT = os.environ.get("OUTP", "_PREVIEW_strap_boots.png")
FRAMES = [(0, "idle"), (12, "walk"), (22, "run"), (41, "cheer"), (52, "slash")]
CLASSES = [
    ("warrior", "boots_warrior_legendary_strap", "Ironclasp Warboots"),
    ("mage", "boots_mage_legendary_strap", "Astral Clasp Striders"),
    ("ranger", "boots_ranger_legendary_strap", "Wildclasp Striders"),
]
...
def main():
    ...
    for cls, stem, disp in CLASSES:
        d.text((pad, y), f"{disp}  ({cls}, HYPER-RARE boots — net-new HORIZONTAL BUCKLE-STRAP, 8th boots axis (repaint, QA-safe))",
