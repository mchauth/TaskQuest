...
and gender: full avatar (skin + base pants + base shirt + lace boots + hair)
...
_PREVIEW_lace_boots.png)."""
import os
from PIL import Image, ImageDraw, ImageFont

CH = "sprites/preview_assets/char"
PREV = "_lace_boots_preview"
FW, FH, COLS = 80, 64, 10
OUT = os.environ.get("OUTP", "_PREVIEW_lace_boots.png")
FRAMES = [(0, "idle"), (12, "walk"), (22, "run"), (41, "cheer"), (52, "slash")]
CLASSES = [
    ("warrior", "boots_warrior_legendary_lace", "Ironlace Warboots"),
    ("mage", "boots_mage_legendary_lace", "Astral Laced Striders"),
    ("ranger", "boots_ranger_legendary_lace", "Wildlace Striders"),
]
...
def main():
    ...
    for cls, stem, disp in CLASSES:
        d.text((pad, y), f"{disp}  ({cls}, HYPER-RARE boots — net-new CROSS-LACING, 7th boots axis (repaint, QA-safe))",
