...
_PREVIEW_kneeband_legs.png)."""
import os
from PIL import Image, ImageDraw, ImageFont

CH = "sprites/preview_assets/char"
PREV = "_kneeband_legs_preview"
FW, FH, COLS = 80, 64, 10
OUT = os.environ.get("OUTP", "_PREVIEW_kneeband_legs.png")
FRAMES = [(0, "idle"), (12, "walk"), (22, "run"), (41, "cheer"), (52, "slash")]
CLASSES = [
    ("warrior", "pants_warrior_legendary9", "Warlord Knee-Guard"),
    ("mage", "pants_mage_legendary9", "Astral Articulation"),
    ("ranger", "pants_ranger_legendary9", "Warden Knee-Wrap"),
]
...
def main():
    ...
    for cls, stem, disp in CLASSES:
        d.text((pad, y), f"{disp}  ({cls}, LEGENDARY legs — net-new HORIZONTAL KNEE-BAND, 9th legs axis (repaint, QA-safe))",
