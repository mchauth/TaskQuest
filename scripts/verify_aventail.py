#!/usr/bin/env python3
"""Rigorous per-sheet verification for the aventail (camail) helmets.
For each of the 6 sheets, vs its source helmet sheet:
  ...
  3. accent-caused multi-component frames = frames whose OUTPUT has >1 connected
     component beyond what the SOURCE already has (0 -> every drape fused)
...
PAIRS = [
    ("helmet_rare1", "helmet_warrior_legendary4"),
    ("helmet_mage4", "helmet_mage_legendary4"),
    ("helmet_ranger4", "helmet_ranger_legendary4"),
]
