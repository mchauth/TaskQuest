#!/usr/bin/env python3
"""Approval preview for the 4th legendary sets: Malachite Magus (mage) + Nightbloom
...
from, right = the NEW legendary. Writes _PREVIEW_legendary4.png and a copy to
$OUTDIR/PREVIEW_legendary4.png.
"""
import os
...
SETS = [
    ("Malachite Magus", "mage4", "mage4", (100, 184, 124)),
    ("Nightbloom", "ranger4", "ranger4", (192, 110, 220)),
]
PREV = {"mage4": "_mage_legendary4_preview", "ranger4": "_ranger_legendary4_preview"}
...
def main():
    ...
    img.convert("RGB").save("_PREVIEW_legendary4.png")
    outdir = os.environ.get("OUTDIR", ".")
    img.convert("RGB").save(os.path.join(outdir, "PREVIEW_legendary4.png"))
    print("wrote _PREVIEW_legendary4.png", img.size)
