...
draped-kilt geometry is clear. Writes to $OUTP (default PREVIEW_warkilt_legs.png)."""
import os
...
FW, FH, COLS = 80, 64, 10
OUT = os.environ.get("OUTP", "PREVIEW_warkilt_legs.png")
FRAMES = [(0, "idle"), (12, "walk"), (22, "run"), (41, "cheer"), (52, "slash")]
CLASSES = [
    ("warrior", "pants_warrior_legendary2", "Warlord's Battle-Kilt"),
    ("mage", "pants_mage_legendary2", "Astral Ritual-Skirt"),
    ("ranger", "pants_ranger_legendary2", "Wildwood War-Kilt"),
]
...
def main():
    ...
    for cls, stem, disp in CLASSES:
        d.text((pad, y), f"{disp}  ({cls}, HYPER-RARE legs — net-new draped war-kilt geometry)",
        ...
        for gender in ("m", "f"):
            ...
            d.text((x + 2, yy + ch * Z), f"{gender} iso (kilt+skin)", font=fsm, fill=(200, 200, 210, 255))
            yy += row_h
        y += class_h + pad
