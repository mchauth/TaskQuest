#!/usr/bin/env python3
"""Rigorous per-sheet verification for the knee-cop poleyn legs.
For each of the 6 sheets, vs its source t4-pants sheet:
  ...
  3. accent-caused multi-component frames = frames whose OUTPUT has >1 connected
     component beyond what the SOURCE already has (should be 0 -> every disc fused)
...
PAIRS = [
    ("armor_pants_4", "pants_warrior_legendary4"),
    ("pants_mage4", "pants_mage_legendary4"),
    ("pants_ranger4", "pants_ranger_legendary4"),
]
