#!/usr/bin/env python3
"""Preview the branching antler-crown helmets for daily approval. Per class and
gender: full avatar (skin + base pants + base shirt + hair + antler helmet) across
idle/walk/run/cheer/slash, plus one isolated helmet-over-skin so the net-new
branching-antler geometry is clear. Writes to $OUTP (default _PREVIEW_antler_helmet.png)."""
import os
from PIL import Image, ImageDraw, ImageFont

CH = "sprites/preview_assets/char"
PREV = "_antler_helmet_preview"
FW, FH, COLS = 80, 64, 10
OUT = os.environ.get("OUTP", "_PREVIEW_antler_helmet.png")
FRAMES = [(0, "idle"), (12, "walk"), (22, "run"), (41, "cheer"), (52, "slash")]
CLASSES = [
    ("warrior", "helmet_warrior_legendary6", "Dreadhorn Warcrown"),
    ("mage", "helmet_mage_legendary6", "Astral Antler-Crown"),
    ("ranger", "helmet_ranger_legendary6", "Wildhorn Stag-Crown"),
]
...
def main():
    ...
    for cls, stem, disp in CLASSES:
        d.text((pad, y), f"{disp}  ({cls}, HYPER-RARE helmet — net-new BRANCHING-ANTLER geometry, 6th helmet axis)",
