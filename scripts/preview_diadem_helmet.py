...
branching-antler geometry is clear. Writes to $OUTP (default _PREVIEW_diadem_helmet.png)."""
import os
from PIL import Image, ImageDraw, ImageFont

CH = "sprites/preview_assets/char"
PREV = "_diadem_helmet_preview"
FW, FH, COLS = 80, 64, 10
OUT = os.environ.get("OUTP", "_PREVIEW_diadem_helmet.png")
FRAMES = [(0, "idle"), (12, "walk"), (22, "run"), (41, "cheer"), (52, "slash")]
CLASSES = [
    ("warrior", "helmet_warrior_legendary7", "Sovereigns Diadem"),
    ("mage", "helmet_mage_legendary7", "Astral Circlet"),
    ("ranger", "helmet_ranger_legendary7", "Wardens Circlet"),
]
...
def main():
    ...
    for cls, stem, disp in CLASSES:
        d.text((pad, y), f"{disp}  ({cls}, HYPER-RARE helmet — net-new jewelled BROW-BAND, 7th helmet axis (repaint, QA-safe))",
